...
urlpatterns = [
    ...
    path('manage_review/', views.ManageReviewList.as_view(),
         name="manage_review"),
    ...
    path('delete_review/<pk>/', views.ReviewDeleteView.as_view(),
         name='delete_review'),
    path('review_like/<pk>/', views.like_view, name="like-review"),
    path('approve_review/<pk>', views.approved_review, name='approved_review'),
]
